...
<style>
    ...
    .celebration-card-photo { position: absolute; z-index: 3; top: 5.5%; left: 50%; width: 34%; height: 34%; transform: translateX(-50%); object-fit: contain; object-position: center center; background: rgba(255, 255, 255, .72); border: clamp(5px, .75vw, 9px) solid #b10f14; border-radius: 50%; box-shadow: 0 .55rem 1.4rem rgba(51, 34, 20, .24); }
