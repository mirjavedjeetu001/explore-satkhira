...
<section class="page-header py-4" style="background: linear-gradient(135deg, #dc3545, #a71d2a);">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="text-white mb-0"><i class="fas fa-edit me-2"></i>ডোনর এডিট</h3>
                <p class="text-white-50 mb-0">{{ $donor->name }}</p>
            </div>
...
<section class="py-4">
    <div class="container">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="{{ route('dashboard.blood.update', $donor->id) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">নতুন পাসওয়ার্ড <small class="text-muted">(ফাঁকা রাখলে আগেরটা থাকবে)</small></label>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-danger"><i class="fas fa-save me-1"></i>আপডেট করুন</button>
                        <a href="{{ route('dashboard.blood.show', $donor->id) }}" class="btn btn-outline-secondary ms-2">বিস্তারিত দেখুন</a>
                    </div>
                </form>
            </div>
        </div>
