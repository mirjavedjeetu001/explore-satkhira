...
@section('title', 'নতুন টিকেট - বাস টিকেট বেচাকেনা')
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-success text-white">
                        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>নতুন টিকেট বিজ্ঞাপন</h4>
                    </div>
                        ...
                        <form method="POST" action="{{ route('bus-ticket.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                @error('contact_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text text-muted">ক্রেতারা এই নম্বরে কল করবে</div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('whatsapp_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text text-muted">থাকলে WhatsApp-এ চলে যাবে, না থাকলে কল হবে</div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-semibold">বিস্তারিত বিবরণ</label>
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                          rows="3" placeholder="অতিরিক্ত তথ্য যেমন: ছাড়ার সময়, কাউন্টারের লোকেশন ইত্যাদি">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-success px-4">
                                    <i class="fas fa-save me-2"></i>পোস্ট করুন
                                </button>
