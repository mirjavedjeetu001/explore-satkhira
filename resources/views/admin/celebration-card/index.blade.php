...
<style>
    ...
    .preview-wrap .celebration-card-photo { position: absolute; z-index: 3; top: 0; left: 0; width: 100%; height: 40%; object-fit: contain; object-position: center center; clip-path: ellipse(80% 100% at 50% 0); filter: drop-shadow(0 .45rem .7rem rgba(51, 34, 20, .2)); }
