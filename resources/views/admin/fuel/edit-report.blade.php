...
<div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <h1><i class="fas fa-edit me-2"></i>রিপোর্ট এডিট করুন</h1>
...
<form action="{{ route('admin.fuel.reports.update', $report->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-info-circle me-1"></i>রিপোর্টকারীর তথ্য</div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
            ...
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-gas-pump me-1"></i>তেলের তথ্য</div>
                <div class="card-body">
                    <div class="row g-3">
                        <!-- Petrol -->
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <label class="form-label small">প্রতি লিটার দাম</label>
        ...
        <div class="col-md-4">
            <!-- Existing Images -->
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-images me-1"></i>বর্তমান ছবি</div>
                <div class="card-body">
            ...
            <!-- Add New Images -->
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-plus me-1"></i>নতুন ছবি যোগ করুন</div>
                <div class="card-body">
                    <input type="file" name="new_images[]" class="form-control" multiple accept="image/*">
                    <small class="text-muted">সর্বোচ্চ ৫MB প্রতিটি ছবি</small>
                </div>
            </div>
            
            <!-- Vote Info -->
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-vote-yea me-1"></i>ভোট তথ্য</div>
...
function deleteImage(reportId, imageName, index) {
    if (confirm('এই ছবিটি মুছে ফেলতে চান?')) {
        fetch(`/admin/fuel/reports/${reportId}/delete-image`, {
            method: 'POST',
            headers: {
        ...
        .catch(() => alert('একটি ত্রুটি হয়েছে'));
    }
}
</script>
@endpush
