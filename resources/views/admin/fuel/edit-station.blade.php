...
@section('title', 'পাম্প সম্পাদনা')

@section('content')
<div class="page-header d-flex justify-content-between align-items-center">
    <h1><i class="fas fa-edit me-2"></i>পাম্প সম্পাদনা</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.fuel.stations.update', $station->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="upazila_id" class="form-select @error('upazila_id') is-invalid @enderror" required>
                        ...
                        @foreach($upazilas as $upazila)
                            <option value="{{ $upazila->id }}" {{ old('upazila_id', $station->upazila_id) == $upazila->id ? 'selected' : '' }}>
                                {{ $upazila->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="google_map_link" class="form-control @error('google_map_link') is-invalid @enderror" 
                           value="{{ old('google_map_link', $station->google_map_link) }}" placeholder="https://maps.google.com/...">
