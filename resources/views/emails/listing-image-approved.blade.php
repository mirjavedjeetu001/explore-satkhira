                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <div style="text-align: center; margin-bottom: 30px;">
                                ...
                                <h2 style="color: #28a745; margin: 0; font-size: 24px;">আপনার বিজ্ঞাপন/ছবি অনুমোদিত হয়েছে!</h2>
                            </div>
                            ...
                            <p style="color: #555; font-size: 15px; line-height: 1.8; margin-bottom: 20px;">
                                অভিনন্দন! আপনার জমা দেওয়া বিজ্ঞাপন/ছবিটি <strong style="color: #28a745;">অনুমোদিত</strong> হয়েছে এবং এখন ওয়েবসাইটে প্রদর্শিত হচ্ছে।
                            </p>
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ route('listings.show', $listingImage->listing->slug ?? '') }}" 
